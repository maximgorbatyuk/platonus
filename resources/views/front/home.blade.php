...
@section('content')
    ...
    <div class="container ">
        ...
        <div class="card card-block my-3">
            <h3 class="text-center" id="loadNew">Итоги внедрения</h3>
            <p>
            ...
            <p>
                Более подробно об итогах внедрения можно узнать, пройдя по ссылке <a href="{{url('results')}}">http://platest.tk/results</a>
            </p>
        </div>

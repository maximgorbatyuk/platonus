...
@section('content')
    ...
    <div class="container mt-2">
        ...
        <div class="card card-block mt-2">
            <h3 class="mb-3 text-md-center">Благодарность от меня</h3>
            <p>
                ...
                но и за моральную поддержку. Также я хочу поблагодарить преподавателя университета Александра Бродилина, который помог с распространением информации о проекте
                по электронной почте среди старост групп.
            </p>
        </div>
